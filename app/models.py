...
class CalculationRequest(BaseModel):
    ...
    fuel_price_home: float = Field(..., gt=0, description="Fuel price at home in EUR/L")
    fuel_price_samnaun: float = Field(..., gt=0, description="Fuel price in Samnaun in EUR/L")
